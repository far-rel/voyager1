...
FILES=cookie.o request_header.o response_header.o server.o
...
cookie.o: src/cookie.c
	gcc $(GLIB) src/cookie.c -c	
...
clean:
	rm -f cookie.o request_header.o response_header.o server.o libvoyager.a
